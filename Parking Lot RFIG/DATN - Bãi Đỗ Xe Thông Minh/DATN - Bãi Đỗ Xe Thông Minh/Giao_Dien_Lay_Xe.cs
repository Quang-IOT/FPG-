...
{
    public partial class Giao_Dien_Lay_Xe : Form
    {
        public Giao_Dien_Lay_Xe()
        {
            InitializeComponent();
        }
        ...
        private void Giao_Dien_Lay_Xe_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                FirebaseResponse data__ = client.Get(@"In4_car_output/" + "My_RFID");
            ...
            try
            {
                ...
                foreach (string count in arr_data_)
                {
                    ...
                    if (count.Contains("str_LoaiVe"))
                    {
                        ...
                        if(data_show_[1].ToString() == "MT") // Month Type
                        {
                            tbx_TienThu.Text = "0 Đ";
                        }
                    }
        ...
        private void btnPass_Click(object sender, EventArgs e)
        {
            ...
            if (ststus_ht == "-1")
            {
                ...
                Thread.Sleep(1000);
                var sent = client.Update(@"In4_car_output/", in4_input_);
                Thread.Sleep(1000);
                var done_ = client.Update(@"In4_car_output/", in4_done_);
                Thread.Sleep(1000);
            }
            else
            {
                MessageBox.Show("Not Data Input");
            }
